...
from src.core import run_pipeline, metadata

# from src.core.data_cleaning import clean_gdp_data
from plugins.ui import views
...
def boot():
    ...
    df = run_pipeline.transform(raw_df)
...
def main():
    ...
    filters = build_sidebar(
        regions, countries, min_year, max_year, st.session_state.query_config
    )
